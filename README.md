...
- **Windows**: `PhotoCuller-windows-portable.exe` — a portable single file,
  no installation: put it anywhere and run it (first launch takes a few extra
  seconds while it unpacks itself). If SmartScreen warns, click
  **More info** → **Run anyway**. Requires the WebView2 runtime
